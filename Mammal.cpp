...
std::ostream& operator<<(std::ostream& lhs, const Color& rhs)
{
	switch (rhs)
	{
	case (Color::UNKNOWN_COLOR): lhs << "Unknown Color";
		break;
	case (Color::BLACK): lhs << "Black";
		break;
	case (Color::GRAY): lhs << "Gray";
		break;
	case (Color::BROWN): lhs << "Brown";
		break;
	case (Color::CREAM): lhs << "Cream";
		break;
	case (Color::CALICO): lhs << "Calico";
		break;
	case (Color::WHITE): lhs << "White";
		break;
	case (Color::GINGER): lhs << "Ginger";
		break;
	default:
